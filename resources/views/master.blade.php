...
<head>
    <base href="../" />
    <title>@yield('judul') | SIMANIEZ</title>
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta charset="utf-8" />
    <meta name="description" content="SIMANIEZ" />
    <meta name="keywords" content="SIMANIEZ" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="SIMANIEZ" />
    <meta property="og:url" content="https://sisenep.com/janiesi2020" />
    <meta property="og:site_name" content="SIMANIEZ" />
    <link rel="canonical" href="https://sisenep.com/janiesi2020" />
    ...
    <style>
        [data-bs-theme=light] {
            --bs-scrolltop-bg-color: var(--bs-warning);
            --bs-scrolltop-bg-color-hover: var(--bs-warning);
        }
    </style>
    @yield('css')
    <script>
                ...
                <div class="app-container container-xxl d-flex align-items-center justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
                        <a href="{{ url('dashboard') }}">
                            <img alt="Logo" src="{{ asset('public/logo.png') }}"
                                class="h-25px h-lg-70px" />
                        </a>
                    </div>
                    <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1"
                        ...
                        <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
                            ...
                            <div class="menu menu-rounded menu-active-bg menu-state-primary menu-column menu-lg-row menu-title-gray-700 menu-icon-gray-500 menu-arrow-gray-500 menu-bullet-gray-500 my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
                                ...
                                <div
                                    class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2 {{ request()->is('dashboard') ? 'here' : '' }}">
                                ...
                                <div
                                    class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2 {{ request()->is('data') ? 'here' : '' }}">
                                ...
                                <div
                                    class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2 {{ request()->is('fpg') ? 'here' : '' }}">
                                    <a href="{{ url('fpg') }}" class="menu-link">
                                        <span class="menu-title">FPG</span>
                                        <span class="menu-arrow d-lg-none"></span>
                                    </a>
                                </div>
                                {{-- <div
                                    class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2 {{ request()->is('hasil') ? 'here' : '' }}">
                                    <a href="{{ url('hasil') }}" class="menu-link">
                                        <span class="menu-title">Hasil</span>
                                        <span class="menu-arrow d-lg-none"></span>
                                    </a>
                                </div> --}}
                                <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2 {{ request()->is('panduan') || request()->is('user') || request()->is('log') ? 'here' : '' }}">
                                    <span class="menu-link">
                                        <span class="menu-title">Menu Lainnya</span>
                                        <span class="menu-arrow d-lg-none"></span>
                                    </span>
                                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->is('panduan') ? 'active' : '' }}" href="{{ url('panduan') }}" title="Panduan penggunaan sistem" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->is('user') ? 'active' : '' }}" href="{{ url('user') }}" title="Berisi daftar pengguna" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                                <span class="menu-icon">
                                        ...
                                        <div class="menu-item">
                                            <a class="menu-link {{ request()->is('log') ? 'active' : '' }}" href="{{ url('log') }}" title="Berisi log aktivitas pengguna" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                                                <span class="menu-icon">
                        ...
                        <div class="app-navbar flex-shrink-0">
                            {{-- <div class="app-navbar-item me-2 me-lg-5">
                                <div class="btn btn-icon bg-gray-200 btn-icon-gray-700 btn-active-light btn-active-color-primary w-35px h-35px w-lg-50px h-lg-50px"
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                    ...
                                    <div class="row g-0">
                                        <div class="col-6">
                                            <a href="../../demo26/dist/apps/projects/budget.html"
                                        ...
                                        <div class="col-6">
                                            <a href="../../demo26/dist/apps/projects/settings.html"
                                        ...
                                        <div class="col-6">
                                            <a href="../../demo26/dist/apps/projects/list.html"
                                        ...
                                        <div class="col-6">
                                            <a href="../../demo26/dist/apps/projects/users.html"
                                    ...
                                    <div class="py-2 text-center border-top">
                                        <a href="../../demo26/dist/pages/user-profile/activity.html"
                            ...
                            <div class="app-navbar-item me-2 me-lg-5">
                                <a class="btn btn-success d-flex flex-center h-35px h-lg-50px"
                                    data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">Buy Now</a>
                            </div> --}}
                            <div class="app-navbar-item" id="kt_header_user_menu_toggle">
                                <div class="cursor-pointer symbol symbol-35px symbol-lg-50px"
                                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                                    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-5 my-1 {{ request()->is('user/profil') ? 'here' : '' }}">
                                        <a href="{{ url('user/profil') }}"
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        <div id="kt_app_toolbar" class="app-toolbar w-100">
                            <div id="kt_app_toolbar_container"
                                class="app-container container-xxl d-flex flex-column">
                                <div class="d-flex flex-stack my-10 my-lg-14">
                                    ...
                                    {{-- <div class="d-flex align-items-center">
                                        <div id="kt_header_search"
                                            class="header-search d-flex align-items-center search-custom w-lg-200px"
                                            ...
                                            <div data-kt-search-element="content"
                                                ...
                                                <form data-kt-search-element="advanced-options-form"
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        ...
                                                        <a href="../../demo26/dist/pages/search/horizontal.html"
                        ...
                        <div
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="" target="_blank"
                                    class="text-gray-800 text-hover-primary">SIMANIEZ</a>
                            </div>
                            <ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
                                ...
                                <li class="menu-item">
                                    <a href="{{ url('user') }}" target="_blank"
                                        class="menu-link px-2">Pengguna</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ url('log') }}" target="_blank"
                                        class="menu-link px-2">Log Aktivitas</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <a href="../../demo26/dist/apps/projects/project.html"
                            ...
                            <div class="timeline-content mb-10 mt-n1">
                                ...
                                <div class="overflow-auto pb-5">
                                    <div
                                        ...
                                        <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                            <img alt="../../demo26/dist/apps/projects/project.html"
                                                class="w-30px me-3"
                        ...
                        <div class="d-flex flex-column align-items-start">
                            <div class="d-flex align-items-center mb-2">
                                <div class="symbol symbol-35px symbol-circle">
                                    <img alt="Pic"
                                        src="{{ asset('public/assets/media/avatars/300-25.jpg') }}" />
                                </div>
                                <div class="ms-3">
                                    <a href="#"
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                <div class="d-flex flex-stack">
                    <div class="d-flex flex-column me-3">
                        <div class="mb-3">
                            <a href="../../demo26/dist/apps/ecommerce/sales/details.html"
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div class="mh-300px scroll-y me-n7 pe-7">
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{ asset('public/assets/media/svg/files/pdf.svg') }}"
                                                            alt="icon" />
                                                    </div>
                                                    <div class="ms-6">
                                                        <a href="#"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{ asset('public/assets/media/svg/files/tif.svg') }}"
                                                            alt="icon" />
                                                    </div>
                                                    <div class="ms-6">
                                                        <a href="#"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{ asset('public/assets/media/svg/files/folder-document.svg') }}"
                                                            alt="icon" />
                                                    </div>
                                                    <div class="ms-6">
                                                        <a href="#"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{ asset('public/assets/media/svg/files/css.svg') }}"
                                                            alt="icon" />
                                                    </div>
                                                    <div class="ms-6">
                                                        <a href="#"
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{ asset('public/assets/media/svg/files/ai.svg') }}"
                                                            alt="icon" />
                                                    </div>
                                                    <div class="ms-6">
                                                        <a href="#"
                                            ...
                                            <div class="d-flex flex-stack py-4">
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-35px">
                                                        <img src="{{ asset('public/assets/media/svg/files/doc.svg') }}"
                                                            alt="icon" />
                                                    </div>
                                                    <div class="ms-6">
                                                        <a href="#"
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100">
                                    ...
                                    <div class="text-center px-4">
                                        <img src="{{ asset('public/assets/media/illustrations/sketchy-1/9.png') }}"
                        ...
                        <div class="mh-300px scroll-y me-n7 pe-7">
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-6.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-5.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-9.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-23.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-12.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-13.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                            ...
                            <div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-35px symbol-circle">
                                        <img alt="Pic"
                                            src="{{ asset('public/assets/media/avatars/300-21.jpg') }}" />
                                    </div>
                                    <div class="ms-5">
                                        <a href="#"
                        ...
                        <div class="py-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="{{ asset('public/assets/media/illustrations/sketchy-1/1.png') }}"
